    ...
    <body>
        <table class="tg" style="undefined;table-layout: fixed; width: 725px">
            ...
            <tr>
                ...
                <td class="tg-bxgz" colspan="1" rowspan="3"><img src="data:image/png;base64, {!! $qrcode !!}"><br> (Safety Officer)</td>
                <td class="tg-bxgz" colspan="2" rowspan="3"><img src="data:image/png;base64, {!! $qrcode !!}"><br> (Kadis K3LH)</td>
                <td class="tg-bxgz" colspan="2" rowspan="3"><img src="data:image/png;base64, {!! $qrcode !!}"><br> (Kadis Keamanan)</td>
            </tr>
            <tr>
            </tr>
            <tr>
