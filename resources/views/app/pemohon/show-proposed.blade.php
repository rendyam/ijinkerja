    ...
    $('.swal-btn-submit').click(function(e) {
        ...
        if (input.files.length === 0) {
            ...
            swal({
                    ...
                    text: "PERHATIAN: Dengan mengupload file, maka file sebelumnya akan terhapus! Mohon lengkapi dengan file sebelumnya jika dibutuhkan! Jika masih ragu, silakan periksa kembali.",
                    type: "warning",
