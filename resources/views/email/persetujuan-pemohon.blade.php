...
<head>
  ...
  <title>Persetujuan Pemohon</title>
                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width">
                  ...
                  <tr>
                    <td style="font-size:24px; text-align:center; padding: 0 75px; color: #6f6f6f;" class="w320 mobile-spacing">
                      Dokumen yang Anda ajukan untuk Ijin Kerja telah terverifikasi oleh Safety Officer. Sekarang setujui Ijin Kerja Anda!
                    </td>
                  </tr>
                </table>
              ...
              <center>
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    <td style="text-align: left;">
                    <br>
                      Klik tombol di bawah ini untuk dapat menyetujui Ijin Kerja Anda! (Sebagai pengganti tanda tangan basah di kertas dokumen)
                    </td>
                  </tr>
                </table>
              </center>
