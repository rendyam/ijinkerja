...
<head>
  ...
  <title>Persetujuan Safety Officer</title>
                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width">
                  ...
                  <tr>
                    <td style="font-size:24px; text-align:center; padding: 0 75px; color: #6f6f6f;" class="w320 mobile-spacing">
                      Dokumen yang diajukan sudah disetujui Pemohon. Sekarang saatnya Anda menyetujui Ijin Kerja!
                    </td>
                  </tr>
                </table>
              ...
              <center>
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    <td style="text-align: left;">
                    <br>
                      Klik tombol di bawah ini untuk dapat menyetujui Ijin Kerja Pemohon! (Sebagai pengganti tanda tangan basah di kertas dokumen)
                    </td>
                  </tr>
                </table>
              </center>
