...
<head>
  ...
  <title>Penerbitan Ijin Kerja</title>
                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width">
                  ...
                  <tr>
                    <td style="font-size:24px; text-align:center; padding: 0 75px; color: #6f6f6f;" class="w320 mobile-spacing">
                      Ijin Kerja sudah disetujui semua pihak (Pemohon, Safety Officer, Kadis K3LH). Sekarang Anda mengunduh Ijin Kerja!
                    </td>
                  </tr>
                </table>
              ...
              <center>
                <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    ...
                    <br>
                    <strong>Nomor Lembar Ijin Kerja (LIK):</strong><br>
                      {{ $nomor_lik }}
                    </td>
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    <td style="text-align: left;">
                    <br>
                      Klik tombol di bawah ini untuk dapat melihat Ijin Kerja! (Sebagai pengganti kertas dokumen)
                    </td>
                  </tr>
                </table>
              </center>
