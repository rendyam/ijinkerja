...
<head>
  ...
  <title>Reject Dokumen Pendukung yang telah diupload</title>
                ...
                <table cellspacing="0" cellpadding="0" class="force-full-width">
                  <tr>
                    ...
                    <div class="mobile-br">&nbsp;</div>
                      Dokumen Anda di-Reject!
                    <br/>
                    </td>
                  </tr>
                  <tr>
                    <td style="font-size:24px; text-align:center; padding: 0 75px; color: #6f6f6f;" class="w320 mobile-spacing">
                      Dokumen yang Anda ajukan untuk Ijin Kerja telah di-reject (tolak) oleh Safety Officer. Mohon periksa dokumen tersebut!
                    </td>
                  </tr>
                </table>
              ...
              <center>
                <table style="margin:0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  ...
                  <tr>
                    <td style="text-align:left;">
                    <br>
                    <strong>Catatan Reject:</strong><br>
                      {{ $note_reject }}
                    </td>
                    <td style="text-align:right; vertical-align:top;">
                    <br>
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    <td style="text-align: left;">
                    <br>
                      Klik tombol di bawah ini untuk dapat memeriksa dokumen pendukung yang telah di-reject oleh Safety Officer
                    </td>
                  </tr>
                </table>
              </center>
                  ...
                  <br>
                    <div><!--[if mso]>
                      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:45px;v-text-anchor:middle;width:180px;" stroke="f" fillcolor="#f5774e">
                        ...
                        <center>
                      <![endif]-->
                          <a href="{{ route('showIjinKerjaPemohon', $id) }}"
              ...
              <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                ...
                <tr>
                  <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;">
                    © 2020 All Rights Reserved - {{ config('app.name', 'Laravel') }} <br> PT KRAKATAU BANDAR SAMUDERA
                  </td>
                </tr>
                <tr>
